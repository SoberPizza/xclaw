"""Pipeline debug runner — dumps perception results to logs/debug/.

Usage:
    python -m xclaw.debug.pipeline [--image PATH]
"""
...
def _dump_perception(result) -> dict:
    """Write perception.json and return stats."""
    ...
    _write_json(DEBUG_DIR / "perception.json", data)
...
def run(image_path: str | None = None) -> None:
    ...
    print("  Perception...")
    summary["perception"] = _dump_perception(result)
